...
//
//  private class GetUrlTask {
//    private static final String API_GET_INFO="&method=flickr.photos.getInfo";
//    GetUrlTask(final Photo p, final ArrayList<Photo> list) {
//      Log.e(TAG, "GetUrlTask " + p.id);
//      OkHttpClient client = new OkHttpClient();
//      StringBuilder builder = new StringBuilder();
//      builder.append(URL_BASE);
//      builder.append(API_GET_INFO);
//      builder.append("&photo_id="+p.id);
//      builder.append("&secret="+p.secret);
//      Request request = new Request.Builder()
//          .url(builder.toString())
//          .build();
//
...
////          https://farm4.staticflickr.com/3925/33240242871_dd92b3a645.jpg
//          try {
//            JSONObject json = new JSONObject(getJson(response));
//            JSONObject jo = json.getJSONObject("photo");
//            p.url = String.format("https://farm%s.staticflickr.com/%s/%s_%s.jpg",
//                jo.getString("farm"),
//                jo.getString("server"),
//                jo.getString("id"),
